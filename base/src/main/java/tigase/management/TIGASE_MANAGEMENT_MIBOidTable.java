/*
 * TIGASE_MANAGEMENT_MIBOidTable.java
 *
...
/**
 * The class contains metadata definitions for "TIGASE-MANAGEMENT-MIB". Call SnmpOid.setSnmpOidTable(new
 * TIGASE_MANAGEMENT_MIBOidTable()) to load the metadata in the SnmpOidTable.
 */
public class TIGASE_MANAGEMENT_MIBOidTable
